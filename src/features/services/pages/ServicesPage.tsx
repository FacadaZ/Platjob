...
const CATEGORY_DETAILS: Record<string, { icon: React.ComponentType<{ className?: string }>; color: string; description: string; price: string }> = {
  electricista: { icon: Zap, color: "bg-yellow-100 text-yellow-600", description: "Instalaciones eléctricas, tableros, iluminación y más.", price: "Desde 40 Bs/hr" },
  plomero: { icon: Wrench, color: "bg-blue-100 text-blue-600", description: "Reparación de fugas, sanitarios y tuberías.", price: "Desde 35 Bs/hr" },
  carpintero: { icon: Hammer, color: "bg-amber-100 text-amber-700", description: "Muebles a medida, pisos y estructuras de madera.", price: "Desde 45 Bs/hr" },
  pintor: { icon: PaintBucket, color: "bg-purple-100 text-purple-600", description: "Pintura de interiores, exteriores y texturas.", price: "Desde 30 Bs/hr" },
  cerrajero: { icon: Key, color: "bg-gray-100 text-gray-700", description: "Apertura de puertas, cerraduras digitales y más.", price: "Desde 50 Bs/hr" },
  climatizacion: { icon: Wind, color: "bg-cyan-100 text-cyan-600", description: "Instalación y mantenimiento de aires acondicionados.", price: "Desde 60 Bs/hr" },
  jardinero: { icon: Leaf, color: "bg-green-100 text-green-600", description: "Diseño de jardines, poda y mantenimiento.", price: "Desde 25 Bs/hr" },
  soldador: { icon: Flame, color: "bg-red-100 text-red-600", description: "Soldadura en estructura metálica y rejas.", price: "Desde 45 Bs/hr" },
  albanil: { icon: HardHat, color: "bg-orange-100 text-orange-700", description: "Trabajos de albañilería, colocación de ladrillos y reformas.", price: "Desde 35 Bs/hr" },
  limpieza: { icon: Sparkles, color: "bg-teal-100 text-teal-600", description: "Servicios de limpieza profunda para casas y oficinas.", price: "Desde 20 Bs/hr" },
};
